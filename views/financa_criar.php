<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Criar Receita / Despesa</h5>
                                <span>
                                    <?php
                                    if(!empty($aviso)){
                                            echo $aviso;
                                ...
                                <div class="card-body">
                                    <form id="validationform" method="post" action="<?=BASE_URL?>financa/criacao">
                                        <div class="form-group">
                                                ...
                                                <?php foreach($tipoentradaArray as $tipoentradaEntity):?>
                                                    <option value="<?=$tipoentradaEntity['id']?>"><?=$tipoentradaEntity['descricao']?></option>
                                                <?php endforeach;?>
                                                </select>
                                        </div>
                                        <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Descrição</label>
                                                <input id="inputText3" type="text" name="descricao" required="Favor preencher a descrição." data-parsley-maxlength="255" placeholder="Descrição da finança" class="form-control">
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <?php foreach($categoriaArray as $categoriaEntity):?>
                                                    <option value="<?=$categoriaEntity['id']?>"><?=$categoriaEntity['descricao']?></option>
                                                <?php endforeach;?>
                                                </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Dia de débito <small class="text-muted">yyyy/mm/dd</small></label>
                                            <input type="text" class="form-control date-inputmask" id="date-mask" placeholder="yyyy/mm/dd" name="data_debito">
                                        </div>
