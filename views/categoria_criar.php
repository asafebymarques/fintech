<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" method="post" action="<?=BASE_URL?>categoria/criacao">
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Descrição</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="descricao" required="Favor preencher a descrição." data-parsley-maxlength="255" placeholder="Descrição da categoria" class="form-control">
                                            </div>
                                        </div>
