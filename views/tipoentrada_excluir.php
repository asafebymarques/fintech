<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Excluir Tipo de entrada</h5>
                                    <span>
                                    <?php
                                    if(!empty($aviso)){
                                            echo $aviso;
                                ...
                                <div class="card-body">
                                <p>Deseja excluir o tipo de entrada abaixo?</p>
                                    <form id="validationform" method="post" action="<?=BASE_URL?>tipoentrada/deletar">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" value="<?=$tipoentradaEdit['descricao']?>" name="descricao"  data-parsley-maxlength="255" placeholder="Descrição do tipo de entrada" class="form-control" readonly>
                                            </div>
                                        </div>
