		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Preencher o nome">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Preencher CPF">
					...
					<input type="submit" class="login100-form-btn" value="Cadastrar-se">
					</div>
